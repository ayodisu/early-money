                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../assets/config/deposit_config.php?ver=<?php echo $row['id']; ?>&acct=<?php echo $row['acct_num']; ?>&amt=<?php echo $row['amount']; ?>" class="btn btn-primary <?php echo ($row['d_status'] == '1')?'d-none':''; ?>">
