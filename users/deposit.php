    ...
    <section>
        <div class="container p-2 p-md-5">
            <div class="card p-3 shadow">
                <h2>Deposit</h2>
                <form action="../assets/config/deposit_config.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="amount" placeholder="min:100" class="form-control" min="100" required>
                        </div>

                        <div class="col-12">
                            <input type="submit" name="deposit" value="Deposit" class="btn btn-dark">
                        </div>
                    </div>
                </form>
                <div class="table-responsive mt-5">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM deposit WHERE acct_num = '$acct' ORDER BY id DESC";
                            $query = mysqli_query($connectDB, $sql);
